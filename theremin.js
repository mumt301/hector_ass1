...
function thereminControl(e, oscillator, oscillator2, semitone_choice, min_fr, max_fr, theremin) {
    ...
    if(semitone_choice=="maj_third"){
        thereminFreq2 = interval(thereminFreq,4);
    }else if (semitone_choice=="min_third"){
        thereminFreq2 = interval(thereminFreq,3);
    }else if (semitone_choice=="perf_fifth"){
        thereminFreq2 = interval(thereminFreq,7);
    }else if (semitone_choice=="octave"){
        thereminFreq2 = interval(thereminFreq,14);
    }
    ...
    document.getElementById("frequency").innerHTML = "Frequency currently played: "+thereminFreq;
    document.getElementById("noteName").innerHTML = "Note currently played is (approximalty): "+noteFromFrequency(thereminFreq);
}
...
function runAfterLoadingPage() {
    ...
    // TODO: look for semitone paramters 
