...
function runAfterLoadingPage(){
    ...
    var church_background = new Pizzicato.Sound('./media/final_proj/church_background.wav', volume=0.2, loop=true, function() {
        console.log('Church background sound ready to be used.');
    });

    var cave_background = new Pizzicato.Sound('./media/final_proj/cave_background.wav', volume=0.2, loop=true, function() {
